            ...
            <form action="{{ route('barang.update', $barang->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-12 col-12">
                        <div class="mb-3">
                            <img id="preview"
                                src="{{ $barang->foto ? Storage::url($barang->foto) : asset('images/no-photo.png') }}"
                                alt="foto barang"
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-12">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ $barang->nama }}" class="form-control" id="nama"
                                name="nama" required>
                        </div>
                        <div class="mb-3">
                            <label for="detail" class="form-label">Detail Barang</label>
                            <textarea rows="4" class="form-control" id="detail" name="detail" placeholder="{{$barang->detail}}"
                                required></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="harga" class="form-label">Harga Rp</label>
                            <input value="{{ $barang->harga }}" type="number" class="form-control id="harga"
                                name="harga" required>
                        </div>
                        <div class="mb-3">
                            ...
                            <select class="form-control" name="id_jenis" id="id_jenis">
                                ...
                                @foreach ($banyakJenis as $jenis)
                                    <option value="{{ $jenis->id }}"
                                        {{ $barang->id_jenis == $jenis->id ? 'selected' : '' }}>{{ $jenis->jenis }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
